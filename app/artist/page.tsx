...
export default function ArtistLogin() {
  ...
  useEffect(() => {
    // THE KILL SWITCH FUSE: Force loading off after 1.5 seconds unconditionally.
  ...
  const checkUser = async () => {
    try {
      ...
      // Race condition: Don't let Supabase hang forever
      ...
      console.error("Auth check failed or timed out.");
